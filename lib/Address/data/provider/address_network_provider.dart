...
class AddressNetworkProvider extends ApiService {
  ...
  Future<Map<String, dynamic>> addAddress(String token, Address address) async {
  ...
  Future<Map<String, dynamic>> editAddress(String token, Address address) async {
    final Response response = await dio.post(
      Urls.EDIT_ADDRESS,
      options: Options(
        headers: {
  ...
  Future<List<dynamic>> deleteAddress(String token, String addressId) async {
    final Response response = await dio.post(
      Urls.DELETE_ADDRESS,
      options: Options(
        headers: {
