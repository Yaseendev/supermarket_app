...
import 'package:supermarket_app/Address/blocs/address_bloc/address_bloc.dart';
        ...
        children: [
          Column(
            children: [
              ...
              //                 title: Text(state.selectedAddress.toString()),
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                //           onPressed:state is CheckoutLoading ? null : () {
                //             if(selectedAddress != null){
                //             context.read<CheckoutBloc>().add(CheckoutOrder(addressId: selectedAddress!.id ?? '', notes: notes));
                //             } else {
