...
class CartNetworkProvider extends ApiService {
  ...
  Future<Map<String, dynamic>> addCart(String token, CartItem item) async {
    final Response response = await dio.post(
      ...
      data: FormData.fromMap(item.toMapForAdd()),
    );
    return response.data;
  }
  ...
  Future<Map<String, dynamic>> multiAddCart(
    ...
    final Response response = await dio.post(
      ...
      data: FormData.fromMap({'items': items}),
    );
    return response.data;
  }
    ...
    final Response response = await dio.post(
      ...
      data: FormData.fromMap(item.toMap()),
    );
    return response.data;
  }

    Future<Map<String, dynamic>> removeFromCart(String token, String itemId) async {
    final Response response = await dio.post(
      Urls.REMOVE_CART,
      options: Options(
        headers: {
    ...
    Future<Map<String, dynamic>> checkoutOrder(String token, String addressId, String notes) async {
    final Response response = await dio.post(
      Urls.CHECKOUT,
      options: Options(
        headers: {
